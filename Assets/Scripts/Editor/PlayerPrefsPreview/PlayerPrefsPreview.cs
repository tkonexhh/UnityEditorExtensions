...
public class PlayerPrefsEditor : EditorWindow
{
    ...
    [MenuItem(ToolsDefine.ToolRoot + "PlayerPrefs Editor _F6")]
    ...
    private void OnGUI()
    {
        ...
        if (Event.current.modifiers.Equals(Event.KeyboardEvent("F5").modifiers) &&
          Event.current.keyCode == Event.KeyboardEvent("F5").keyCode)
        {
            Refresh();
        }
    }
