//引用自https://github.com/XINCGer/UnityToolchainsTrick/tree/main/Assets/Editor/Examples/Example_03_EditorIcons
using System.IO;
...
namespace ToolKits
{
    ...
    {
        [MenuItem(ToolsDefine.ToolRoot + "Editor Icons %e", priority = 3)]
