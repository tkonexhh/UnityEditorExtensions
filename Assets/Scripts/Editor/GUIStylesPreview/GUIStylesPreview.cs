//引用自https://github.com/756915370/UnityEditorExtension/blob/master/Assets/Editor/GUIStyleViewer.cs
...
{
    [MenuItem(ToolsDefine.ToolRoot + "GUIStyle预览 (GUIStyleViewer)", false, 100)]
    ...
    void OnGUI()
    {
        ...
        string newSearch = EditorGUILayout.TextField("Search", _search, "SearchTextField");
